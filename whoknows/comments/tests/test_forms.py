...
class CommentTest(TestCase):
    ...
    def test_valid_form(self):
        form = CommentForm(data={'object_id': '1', 'comment_type': 'question', 'content': 'test comment'})
        self.assertTrue(form.is_valid())
        form = CommentForm(data={'object_id': '1', 'comment_type': 'answer', 'content': 'test comment'})
        self.assertTrue(form.is_valid())
    ...
    def test_all_fields_required(self):
        ...
        comment_type_error = str(form.errors['comment_type'].as_data()[0].message)
    ...
    def test_valid_comment_types(self):
        form = CommentForm(data={'object_id': '1', 'comment_type': 'invalid', 'content': 'test comment'})
        self.assertFalse(form.is_valid())
