...
from .views import HomePage, QuestionCreate, QuestionDetail, TagsList, TaggedQuestionList, QuestionSearch
...
urlpatterns = [
    ...
    path('question/search/', QuestionSearch.as_view(), name='search'),
